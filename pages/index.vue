<template>
    <div>
        ...
        <p class="mt-4 text-xs">
           <strong>Pozn.:</strong> S účtem <NuxtLink to="https://twitter.com/MasterCoda" :external="true">MasterCoda</NuxtLink>
           na Twitteru nemám nic společného.
        </p>
    </div>
</template>