<template>
  <div>
    ...
    <div class="article">
      ...
      <p>
        Pokud však proměnná variable může být null (což předpokládejte vždycky, ledaže jste si 100% jistí, že tam
        vaše aplikace null nepustí), je tohle pozvánka pro <span class="code">NullPointerException</span>, aby
        na nás vyskočil, až se to bude nejméně hodit.
      </p>
      ...
      <p>
        Což je samo o&nbsp;sobě správně. Akorát je to zbytečně moc písmenek a&nbsp;můžeme to napsat jednodušeji.
        Stačí otočit pořadí. Vůbec nic nám nebrání porovnávat:
      </p>
      <div class="code">
        <span class="j-key">if</span>
      ...
      <p>
        Implementace metody <span class="code">.equals()</span> pro <span class="code">String</span> má porovnání
        s&nbsp;null argumentem vyřešeno –&nbsp;jak porovnání dvou objektů pomocí <span class="code">==</span>,
        tak operátor <span class="code">instanceof</span> si s&nbsp;null hodnotou poradí.
        <span class="code">NullPointerException</span> nás ohrožuje pouze tehdy, pokud se
        <span class="code">.equals()</span> snažíme zavolat na null objekt. A&nbsp;jelikož řetězec "hodnota"
        logicky nikdy null nebude, máme vyřešeno.
      </p>

      <p>
        Doporučuji si ještě zvyknout nenechávat podobné řetězce přímo v&nbsp;kódu, ale vytahovat si je jako
        konstanty:
      </p>
      <div class="code">
      ...
      <p>
        I&nbsp;kdybyste ji potřebovali pouze jednou, toto vám pomůže držet definice na jednom místě
        ...
        nenapadlo plevelit aplikaci jejími instancemi) použitelných podle potřeby kdekoliv jinde.
      </p>
      ...
      <div class="code">
        <span class="j-key">if</span>
        (Optional.ofNullable(<span class="j-var">variable</span>).orElse(<span class="j-lit">""</span>)
        .equals(<span class="j-lit">"hodnota"</span>))
        {<span class="j-com">…</span>}
      </div>
      ...
      <div class="code">
        ...
        >variable</span>);<br>
        <span class="j-com">…</span><br>
        <span class="j-key">if</span> (<span class="j-var">optVar</span>.orElse(<span class="j-lit">""</span>)
        .equals(<span class="j-lit">"hodnota"</span>))
        {<span class="j-com">…</span>}
      </div>
